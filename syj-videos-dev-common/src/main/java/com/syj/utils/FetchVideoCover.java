...
//		ffmpeg.exe -ss 00:00:01 -i spring.mp4 -vframes 1 bb.jpg
	...
	public static void main(String[] args) {
		// 获取视频信息。
		FetchVideoCover videoInfo = new FetchVideoCover("E:\\soft\\ffmpeg\\bin\\ffmpeg.exe");
		try {
			videoInfo.getCover("E:\\soft\\ffmpeg\\bin\\spring.mp4","E:\\soft\\ffmpeg\\bin\\spring.jpg");
